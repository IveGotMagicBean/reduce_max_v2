...
public:
                                ...
                                GM_ADDR workspace, GM_ADDR tiling)
    {
        ...
        yGm.SetGlobalBuffer((__gm__ T*)y,            totalOut * ALIGN_NUM);
        idxGm.SetGlobalBuffer((__gm__ int32_t*)idx,  totalOut * ALIGN_NUM);
...
private:
                                              ...
                                              T& maxVal, int32_t& maxIdx)
    {
        ...
        if (tailLen > 0) {
            ...
            // 只读 safeCopyLen（tailLen 按16对齐），避免越过 GlobalMemory 边界读脏数据
            ...
            // 把 [tailLen, padLen) 填为 -65504，防止脏数据影响 max 结果
